...
namespace LoginTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string randomState = new Address().State();
            string randomCountry = new Address().Country();
            ...
            //Console.WriteLine(randomCompany);
            //Console.WriteLine(randomAddress1);
            //Console.WriteLine(randomAddress2);
            //Console.WriteLine(randomCity);
            //Console.WriteLine(randomState);
            //Console.WriteLine(randomCountry);
            //Console.WriteLine(randomOther);
            //Console.WriteLine(randomHomePhoneNumber);
            //Console.WriteLine(randomMobilePhoneNumber);
